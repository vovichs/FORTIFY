  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2_d.w = ((-_Glossiness.y) + 1);
          u_xlat3_d.x = dot((-u_xlat1_d.xyzx), in_f.texcoord1.xyzx);
          u_xlat3_d.x = (u_xlat3_d.x + u_xlat3_d.x);
          u_xlat3_d.xyz = ((in_f.texcoord1.xyz * (-u_xlat3_d.xxx)) - u_xlat1_d.xyz);
          ...
          u_xlat1_d.w = (((-u_xlat2_d.w) * 0.7) + 1.7);
          u_xlat1_d.w = (u_xlat1_d.w * u_xlat2_d.w);
          u_xlat1_d.w = (u_xlat1_d.w * 6);
          u_xlat5_d = tex2D(unity_SpecCube0, u_xlat5_d.xy);
          u_xlat3_d.w = (u_xlat5_d.w - 1);
          u_xlat3_d.w = ((unity_SpecCube1_HDR.w * u_xlat3_d.w) + 1);
          u_xlat3_d.w = (u_xlat3_d.w * unity_SpecCube1_HDR.x);
          u_xlat6_d.xyz = (u_xlat5_d.xyz * u_xlat3_d.www);
          ...
          if((u_xlat4_d.w!=0))
          {
              ...
              if((u_xlat4_d.w!=0))
              {
                  u_xlat4_d.w = dot(u_xlat3_d.xyzx, u_xlat3_d.xyzx);
                  u_xlat4_d.w = rsqrt(u_xlat4_d.w);
                  u_xlat7.xyz = (u_xlat3_d.xyz * u_xlat4_d.www);
                  ...
                  u_xlat4_d.w = min(u_xlat8.y, u_xlat8.x);
                  u_xlat4_d.w = min(u_xlat8.z, u_xlat4_d.w);
                  u_xlat8.xyz = (in_f.texcoord2.xyz - unity_SpecCube1_HDR.xyz);
                  u_xlat3_d.xyz = ((u_xlat7.xyz * u_xlat4_d.www) + u_xlat8.xyz);
              }
              u_xlat7 = tex2D(unity_SpecCube1, u_xlat3_d.xy);
              u_xlat1_d.w = (u_xlat7.w - 1);
              u_xlat1_d.w = ((unity_SpecCube1_HDR.w * u_xlat1_d.w) + 1);
              u_xlat1_d.w = (u_xlat1_d.w * unity_SpecCube1_HDR.x);
              u_xlat3_d.xyz = (u_xlat7.xyz * u_xlat1_d.www);
              u_xlat5_d.xyz = ((u_xlat3_d.www * u_xlat5_d.xyz) - u_xlat3_d.xyz);
          ...
          u_xlat1_d.w = ((_Glossiness.x * (-0.220916)) + 0.220916);
          u_xlat3_d.w = (((-_Glossiness.x) * 0.779084) + 0.779084);
          ...
          u_xlat1_d.y = saturate(dot(u_xlat3_d.xyzx, u_xlat0_d.xyzx));
          u_xlat0_d.x = saturate(dot(unity_OcclusionMaskSelector.xyzx, u_xlat0_d.xyzx));
          u_xlat0_d.y = (u_xlat2_d.w * u_xlat2_d.w);
          u_xlat0_d.y = max(u_xlat0_d.y, 0.002);
          u_xlat0_d.z = ((-u_xlat0_d.y) + 1);
          u_xlat1_d.z = ((abs(u_xlat0_d.w) * u_xlat0_d.z) + u_xlat0_d.y);
          u_xlat0_d.z = ((u_xlat1_d.x * u_xlat0_d.z) + u_xlat0_d.y);
          u_xlat0_d.z = (u_xlat0_d.z * abs(u_xlat0_d.w));
          u_xlat0_d.z = ((u_xlat1_d.x * u_xlat1_d.z) + u_xlat0_d.z);
          u_xlat0_d.z = (u_xlat0_d.z + 1E-05);
          u_xlat0_d.z = (0.5 / u_xlat0_d.z);
          u_xlat1_d.z = (u_xlat0_d.y * u_xlat0_d.y);
          u_xlat3_d.x = ((u_xlat1_d.y * u_xlat1_d.z) - u_xlat1_d.y);
          u_xlat1_d.y = ((u_xlat3_d.x * u_xlat1_d.y) + 1);
          u_xlat1_d.z = (u_xlat1_d.z * 0.31831);
          u_xlat1_d.y = ((u_xlat1_d.y * u_xlat1_d.y) + 0);
          u_xlat1_d.y = (u_xlat1_d.z / u_xlat1_d.y);
          u_xlat0_d.z = (u_xlat0_d.z * u_xlat1_d.y);
          u_xlat0_d.yz = (u_xlat0_d.yz * float2(0.28, 3.141593));
          u_xlat0_d.z = max(u_xlat0_d.z, 0.0001);
          u_xlat0_d.z = sqrt(u_xlat0_d.z);
          u_xlat0_d.z = (u_xlat1_d.x * u_xlat0_d.z);
          u_xlat0_d.y = (((-u_xlat0_d.y) * u_xlat2_d.w) + 1);
          u_xlat1_d.x = dot(u_xlat1_d.wwww, u_xlat1_d.wwww);
          u_xlat1_d.x = (u_xlat1_d.x!=0);
          u_xlat1_d.x = u_xlat1_d.x;
          u_xlat0_d.z = (u_xlat0_d.z * u_xlat1_d.x);
          u_xlat1_d.x = ((-u_xlat3_d.w) + 1);
          u_xlat1_d.x = saturate((u_xlat1_d.x + _Glossiness.y));
          u_xlat3_d.xyz = (u_xlat4_d.xyz * u_xlat0_d.zzz);
          u_xlat0_d.x = ((-u_xlat0_d.x) + 1);
          u_xlat0_d.z = (u_xlat0_d.x * u_xlat0_d.x);
          u_xlat0_d.z = (u_xlat0_d.z * u_xlat0_d.z);
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat0_d.z);
          u_xlat0_d.z = ((-u_xlat1_d.w) + 1);
          u_xlat0_d.x = ((u_xlat0_d.z * u_xlat0_d.x) + u_xlat1_d.w);
          u_xlat4_d.xyz = (u_xlat6_d.xyz * u_xlat0_d.yyy);
          u_xlat0_d.y = ((-abs(u_xlat0_d.w)) + 1);
          u_xlat0_d.z = (u_xlat0_d.y * u_xlat0_d.y);
          u_xlat0_d.z = (u_xlat0_d.z * u_xlat0_d.z);
          u_xlat0_d.y = (u_xlat0_d.y * u_xlat0_d.z);
          u_xlat0_d.z = ((-u_xlat1_d.w) + u_xlat1_d.x);
          u_xlat0_d.y = ((u_xlat0_d.y * u_xlat0_d.z) + u_xlat1_d.w);
          u_xlat0_d.yzw = (u_xlat0_d.yyy * u_xlat4_d.xyz);
          u_xlat0_d.xyz = ((u_xlat3_d.xyz * u_xlat0_d.xxx) + u_xlat0_d.yzw);
          u_xlat0_d.xyz = ((u_xlat2_d.xyz * _Glossiness.xyz) + u_xlat0_d.xyz);
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.w = rsqrt(u_xlat0_d.w);
          u_xlat0_d.xyz = (u_xlat0_d.www * u_xlat0_d.xyz);
          u_xlat1_d.xy = (in_f.texcoord1.yy * _Glossiness.xy);
          u_xlat1_d.xy = ((_Glossiness.xy * in_f.texcoord1.xx) + u_xlat1_d.xy);
          u_xlat1_d.xy = ((_Glossiness.xy * in_f.texcoord1.zz) + u_xlat1_d.xy);
          u_xlat1_d.xy = (u_xlat1_d.xy + _Glossiness.xy);
          ...
          u_xlat1_d.xyz = (u_xlat0_d.www * _Glossiness.xyz);
          u_xlat0_d.w = dot(in_f.texcoord.xyzx, in_f.texcoord.xyzx);
          u_xlat0_d.w = rsqrt(u_xlat0_d.w);
          u_xlat2_d.xyz = (u_xlat0_d.www * in_f.texcoord.xyz);
          u_xlat0_d.w = ((_Glossiness.x * (-0.220916)) + 0.220916);
          u_xlat1_d.w = dot(u_xlat0_d.xyzx, u_xlat2_d.xyzx);
          u_xlat1_d.w = (u_xlat1_d.w + u_xlat1_d.w);
          u_xlat0_d.xyz = ((u_xlat2_d.xyz * (-u_xlat1_d.www)) + u_xlat0_d.xyz);
          u_xlat1_d.w = saturate(dot(u_xlat2_d.xyzx, unity_OcclusionMaskSelector.xyzx));
          u_xlat0_d.x = dot(u_xlat0_d.xyzx, unity_OcclusionMaskSelector.xyzx);
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat0_d.x);
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat0_d.x);
          u_xlat0_d.y = ((-_Glossiness.y) + 1);
          u_xlat2_d = tex2D(unity_NHxRoughness, u_xlat0_d.xy);
          u_xlat0_d.x = (u_xlat2_d.x * 16);
          u_xlat0_d.x = (u_xlat0_d.w * u_xlat0_d.x);
          u_xlat0_d.yzw = (u_xlat1_d.www * u_xlat1_d.xyz);
    ...
    Pass // ind: 3, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          out_f.color1 = ((_Glossiness.xxxy * float4(-0.220916, (-0.220916), (-0.220916), 1)) + float4(0.220916, 0.220916, 0.220916, 0));
          out_f.color2.xyz = ((in_f.texcoord1.xyz * float3(0.5, 0.5, 0.5)) + float3(0.5, 0.5, 0.5));
          out_f.color2.w = 1;
          u_xlat0_d = tex2D(_Main, in_f.texcoord.xy);
          out_f.color3.xyz = (u_xlat0_d.xyz * _Glossiness.xyz);
          out_f.color3.w = 1;
          return out_f;
      }
