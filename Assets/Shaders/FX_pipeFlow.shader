...
Shader "FX/pipeFlow"
{
  Properties
  {
    ...
    _NormalTex ("Normap map (disabled)", 2D) = "bump" {}
    _Glossiness ("Smoothness", Range(0, 1)) = 0.5
    _Metallic ("Metallic", Range(0, 1)) = 0
    _ScrollXSpeed ("X scroll speed", float) = 20
  }
  SubShader
  {
    Tags
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2_d.w = dot(u_xlat0_d.yzwy, u_xlat4_d.xyzx);
          u_xlat4_d.xyz = (in_f.texcoord2.xyz - unity_ShadowFadeCenterAndType.xyz);
          u_xlat3_d.w = length(u_xlat4_d.xyzx);
          u_xlat3_d.w = ((-u_xlat2_d.w) + u_xlat3_d.w);
          u_xlat2_d.w = ((unity_ShadowFadeCenterAndType.w * u_xlat3_d.w) + u_xlat2_d.w);
          ...
          u_xlat3_d.w = (unity_ProbeVolumeMin.x==1);
          if((u_xlat3_d.w!=0))
          {
              u_xlat4_d.x = (unity_ProbeVolumeMin.y==1);
              u_xlat4_d.yzw = (in_f.texcoord2.yyy * unity_ProbeVolumeMin.xyz);
              u_xlat4_d.yzw = ((unity_ProbeVolumeMin.xyz * in_f.texcoord2.xxx) + u_xlat4_d.yzw);
              u_xlat4_d.yzw = ((unity_ProbeVolumeMin.xyz * in_f.texcoord2.zzz) + u_xlat4_d.yzw);
              u_xlat4_d.yzw = (u_xlat4_d.yzw + unity_ProbeVolumeMin.xyz);
              u_xlat4_d.xyz = (u_xlat4_d.xxx)?(u_xlat4_d.yzw):(in_f.texcoord2.xyz);
              u_xlat4_d.xyz = (u_xlat4_d.xyz - unity_ProbeVolumeMin.xyz);
              u_xlat4_d.yzw = (u_xlat4_d.xyz * unity_ProbeVolumeMin.xyz);
              u_xlat4_d.y = ((u_xlat4_d.y * 0.25) + 0.75);
              u_xlat5_d.x = ((unity_ProbeVolumeMin.z * 0.5) + 0.75);
              u_xlat4_d.x = max(u_xlat4_d.y, u_xlat5_d.x);
          ...
          u_xlat4_d.x = saturate(dot(u_xlat4_d, unity_OcclusionMaskSelector));
          u_xlat4_d.yz = (in_f.texcoord5.xy / in_f.texcoord5.ww);
          u_xlat5_d = tex2D(_ShadowMapTexture, u_xlat4_d.yz);
          u_xlat4_d.x = (u_xlat4_d.x - u_xlat5_d.x);
          u_xlat2_d.w = ((u_xlat2_d.w * u_xlat4_d.x) + u_xlat5_d.x);
          u_xlat4_d.x = ((-_Color.y) + 1);
          u_xlat4_d.y = dot((-u_xlat1_d.yzwy), in_f.texcoord1.xyzx);
          u_xlat4_d.y = (u_xlat4_d.y + u_xlat4_d.y);
          u_xlat4_d.yzw = ((in_f.texcoord1.xyz * (-u_xlat4_d.yyy)) - u_xlat1_d.yzw);
          u_xlat5_d.xyz = (u_xlat2_d.www * _Color.xyz);
          if((u_xlat3_d.w!=0))
          {
              u_xlat2_d.w = (unity_ProbeVolumeMin.y==1);
              u_xlat6_d.xyz = (in_f.texcoord2.yyy * unity_ProbeVolumeMin.xyz);
              u_xlat6_d.xyz = ((unity_ProbeVolumeMin.xyz * in_f.texcoord2.xxx) + u_xlat6_d.xyz);
              u_xlat6_d.xyz = ((unity_ProbeVolumeMin.xyz * in_f.texcoord2.zzz) + u_xlat6_d.xyz);
              u_xlat6_d.xyz = (u_xlat6_d.xyz + unity_ProbeVolumeMin.xyz);
              u_xlat6_d.xyz = (u_xlat2_d.www)?(u_xlat6_d.xyz):(in_f.texcoord2.xyz);
              u_xlat6_d.xyz = (u_xlat6_d.xyz - unity_ProbeVolumeMin.xyz);
              u_xlat6_d.yzw = (u_xlat6_d.xyz * unity_ProbeVolumeMin.xyz);
              u_xlat2_d.w = (u_xlat6_d.y * 0.25);
              u_xlat3_d.w = (unity_ProbeVolumeMin.z * 0.5);
              u_xlat5_d.w = (((-unity_ProbeVolumeMin.z) * 0.5) + 0.25);
              u_xlat2_d.w = max(u_xlat2_d.w, u_xlat3_d.w);
              u_xlat6_d.x = min(u_xlat5_d.w, u_xlat2_d.w);
              u_xlat7 = tex3D(unity_ProbeVolumeSH, u_xlat6_d.xz);
              u_xlat8.xyz = (u_xlat6_d.xzw + float3(0.25, 0, 0));
              u_xlat8 = tex3D(unity_ProbeVolumeSH, u_xlat8.xy);
              u_xlat6_d.xyz = (u_xlat6_d.xzw + float3(0.5, 0, 0));
              u_xlat6_d = tex3D(unity_ProbeVolumeSH, u_xlat6_d.xy);
          ...
          u_xlat6_d.xyz = (u_xlat7.xyz + in_f.texcoord3.xyz);
          u_xlat6_d.xyz = max(u_xlat6_d.xyz, float3(0, 0, 0));
          u_xlat6_d.xyz = log(u_xlat6_d.xyz);
          u_xlat6_d.xyz = (u_xlat6_d.xyz * float3(0.416667, 0.416667, 0.416667));
          u_xlat6_d.xyz = exp(u_xlat6_d.xyzx);
          u_xlat6_d.xyz = ((u_xlat6_d.xyz * float3(1.055, 1.055, 1.055)) + float3(-0.055, (-0.055), (-0.055)));
          u_xlat6_d.xyz = max(u_xlat6_d.xyz, float3(0, 0, 0));
          u_xlat0_d.x = (0<unity_SpecCube1_HDR.w);
          if((u_xlat0_d.x!=0))
          {
              u_xlat0_d.x = dot(u_xlat4_d.yzwy, u_xlat4_d.yzwy);
              u_xlat0_d.x = rsqrt(u_xlat0_d.x);
              u_xlat7.xyz = (u_xlat0_d.xxx * u_xlat4_d.yzw);
              ...
              u_xlat0_d.x = min(u_xlat8.y, u_xlat8.x);
              u_xlat0_d.x = min(u_xlat8.z, u_xlat0_d.x);
              u_xlat8.xyz = (in_f.texcoord2.xyz - unity_SpecCube1_HDR.xyz);
              u_xlat7.xyz = ((u_xlat7.xyz * u_xlat0_d.xxx) + u_xlat8.xyz);
          }
          else
          {
              u_xlat7.xyz = u_xlat4_d.yzw;
          }
          u_xlat0_d.x = (((-u_xlat4_d.x) * 0.7) + 1.7);
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat4_d.x);
          ...
          u_xlat3_d.w = (unity_SpecCube1_HDR.w<0.99999);
          if((u_xlat3_d.w!=0))
          {
              u_xlat3_d.w = (0<unity_SpecCube1_HDR.w);
              if((u_xlat3_d.w!=0))
              {
                  u_xlat3_d.w = dot(u_xlat4_d.yzwy, u_xlat4_d.yzwy);
                  u_xlat3_d.w = rsqrt(u_xlat3_d.w);
                  u_xlat9.xyz = (u_xlat3_d.www * u_xlat4_d.yzw);
                  ...
                  u_xlat3_d.w = min(u_xlat10.y, u_xlat10.x);
                  u_xlat3_d.w = min(u_xlat10.z, u_xlat3_d.w);
                  u_xlat10.xyz = (in_f.texcoord2.xyz - unity_SpecCube1_HDR.xyz);
                  u_xlat4_d.yzw = ((u_xlat9.xyz * u_xlat3_d.www) + u_xlat10.xyz);
              }
              u_xlat9 = tex2D(unity_SpecCube1, u_xlat4_d.yz);
              u_xlat0_d.x = (u_xlat9.w - 1);
              u_xlat0_d.x = ((unity_SpecCube1_HDR.w * u_xlat0_d.x) + 1);
              u_xlat0_d.x = (u_xlat0_d.x * unity_SpecCube1_HDR.x);
              u_xlat4_d.yzw = (u_xlat9.xyz * u_xlat0_d.xxx);
              u_xlat7.xyz = ((u_xlat2_d.www * u_xlat7.xyz) - u_xlat4_d.yzw);
              u_xlat8.xyz = ((unity_SpecCube1_HDR.www * u_xlat7.xyz) + u_xlat4_d.yzw);
          }
          u_xlat0_d.x = dot(in_f.texcoord1.xyzx, in_f.texcoord1.xyzx);
          u_xlat0_d.x = rsqrt(u_xlat0_d.x);
          u_xlat4_d.yzw = (u_xlat0_d.xxx * in_f.texcoord1.xyz);
          u_xlat2_d.xyz = ((u_xlat2_d.xyz * _Color.xyz) + float3(-0.220916, (-0.220916), (-0.220916)));
          u_xlat2_d.xyz = ((_Color.zzz * u_xlat2_d.xyz) + float3(0.220916, 0.220916, 0.220916));
          u_xlat0_d.x = (((-_Color.z) * 0.779084) + 0.779084);
          u_xlat3_d.xyz = (u_xlat0_d.xxx * u_xlat3_d.xyz);
          ...
          u_xlat1_d.x = dot(u_xlat4_d.yzwy, u_xlat1_d.yzwy);
          u_xlat1_d.y = saturate(dot(u_xlat4_d.yzwy, unity_OcclusionMaskSelector.xyzx));
          u_xlat1_d.z = saturate(dot(u_xlat4_d.yzwy, u_xlat0_d.yzwy));
          u_xlat0_d.y = saturate(dot(unity_OcclusionMaskSelector.xyzx, u_xlat0_d.yzwy));
          u_xlat0_d.z = (u_xlat0_d.y * u_xlat0_d.y);
          u_xlat0_d.z = dot(u_xlat0_d.zzzz, u_xlat4_d.xxxx);
          ...
          u_xlat0_d.w = (((-u_xlat0_d.w) * u_xlat4_d.x) + 1);
          u_xlat1_d.y = dot(u_xlat2_d.xyzx, u_xlat2_d.xyzx);
          u_xlat1_d.y = (u_xlat1_d.y!=0);
          u_xlat1_d.y = u_xlat1_d.y;
          u_xlat1_d.x = (u_xlat1_d.y * u_xlat1_d.x);
          u_xlat0_d.x = ((-u_xlat0_d.x) + _Color.y);
          u_xlat0_d.x = saturate((u_xlat0_d.x + 1));
          u_xlat4_d.xyz = ((u_xlat5_d.xyz * u_xlat0_d.zzz) + u_xlat6_d.xyz);
          ...
          u_xlat5_d.xyz = ((-u_xlat2_d.xyz) + float3(1, 1, 1));
          u_xlat5_d.xyz = ((u_xlat5_d.xyz * u_xlat0_d.yyy) + u_xlat2_d.xyz);
          u_xlat1_d.xyz = (u_xlat1_d.xyz * u_xlat5_d.xyz);
          u_xlat1_d.xyz = ((u_xlat3_d.xyz * u_xlat4_d.xyz) + u_xlat1_d.xyz);
          u_xlat0_d.yzw = (u_xlat8.xyz * u_xlat0_d.www);
          u_xlat3_d.xyz = ((-u_xlat2_d.xyz) + u_xlat0_d.xxx);
          u_xlat2_d.xyz = ((u_xlat1_d.www * u_xlat3_d.xyz) + u_xlat2_d.xyz);
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2_d.xy = (u_xlat2_d.xy + in_f.texcoord.xy);
          u_xlat2_d = tex2D(_MainTex, u_xlat2_d.xy);
          u_xlat3.xyz = (u_xlat2_d.xyz * _Color.xyz);
          u_xlat4.xy = (in_f.texcoord2.yy * _Color.xy);
          u_xlat4.xy = ((_Color.xy * in_f.texcoord2.xx) + u_xlat4.xy);
          u_xlat4.xy = ((_Color.xy * in_f.texcoord2.zz) + u_xlat4.xy);
          u_xlat4.xy = (u_xlat4.xy + _Color.xy);
          u_xlat1_d.w = (unity_ProbeVolumeMin.x==1);
          if((u_xlat1_d.w!=0))
          {
              u_xlat1_d.w = (unity_ProbeVolumeMin.y==1);
              u_xlat5.xyz = (in_f.texcoord2.yyy * unity_ProbeVolumeMin.xyz);
              u_xlat5.xyz = ((unity_ProbeVolumeMin.xyz * in_f.texcoord2.xxx) + u_xlat5.xyz);
              u_xlat5.xyz = ((unity_ProbeVolumeMin.xyz * in_f.texcoord2.zzz) + u_xlat5.xyz);
              u_xlat5.xyz = (u_xlat5.xyz + unity_ProbeVolumeMin.xyz);
              u_xlat5.xyz = (u_xlat1_d.www)?(u_xlat5.xyz):(in_f.texcoord2.xyz);
              u_xlat5.xyz = (u_xlat5.xyz - unity_ProbeVolumeMin.xyz);
              u_xlat5.yzw = (u_xlat5.xyz * unity_ProbeVolumeMin.xyz);
              u_xlat1_d.w = ((u_xlat5.y * 0.25) + 0.75);
              u_xlat2_d.w = ((unity_ProbeVolumeMin.z * 0.5) + 0.75);
              u_xlat5.x = max(u_xlat1_d.w, u_xlat2_d.w);
              u_xlat5 = tex3D(unity_ProbeVolumeSH, u_xlat5.xz);
          }
          else
          {
              u_xlat5 = float4(1, 1, 1, 1);
          }
          u_xlat1_d.w = saturate(dot(u_xlat5, unity_OcclusionMaskSelector));
          u_xlat4 = tex2D(_LightTexture0, u_xlat4.xy);
          u_xlat1_d.w = (u_xlat1_d.w * u_xlat4.w);
          u_xlat4.xyz = (u_xlat1_d.www * _Color.xyz);
          ...
          u_xlat2_d.xyz = ((u_xlat2_d.xyz * _Color.xyz) + float3(-0.220916, (-0.220916), (-0.220916)));
          u_xlat2_d.xyz = ((_Color.zzz * u_xlat2_d.xyz) + float3(0.220916, 0.220916, 0.220916));
          u_xlat1_d.w = (((-_Color.z) * 0.779084) + 0.779084);
          u_xlat3.xyz = (u_xlat1_d.www * u_xlat3.xyz);
          u_xlat1_d.w = ((-_Color.y) + 1);
          ...
          u_xlat0_d.w = dot(u_xlat5.xyzx, u_xlat1_d.xyzx);
          u_xlat1_d.x = saturate(dot(u_xlat5.xyzx, unity_OcclusionMaskSelector.xyzx));
          u_xlat1_d.y = saturate(dot(u_xlat5.xyzx, u_xlat0_d.xyzx));
          ...
          u_xlat1_d.z = ((-u_xlat0_d.z) + 1);
          u_xlat1_d.w = ((abs(u_xlat0_d.w) * u_xlat1_d.z) + u_xlat0_d.z);
          u_xlat1_d.z = ((u_xlat1_d.x * u_xlat1_d.z) + u_xlat0_d.z);
          u_xlat0_d.w = (abs(u_xlat0_d.w) * u_xlat1_d.z);
          u_xlat0_d.w = ((u_xlat1_d.x * u_xlat1_d.w) + u_xlat0_d.w);
          u_xlat0_d.w = (u_xlat0_d.w + 1E-05);
          u_xlat0_d.w = (0.5 / u_xlat0_d.w);
          u_xlat0_d.z = (u_xlat0_d.z * u_xlat0_d.z);
          u_xlat1_d.z = ((u_xlat1_d.y * u_xlat0_d.z) - u_xlat1_d.y);
          u_xlat1_d.y = ((u_xlat1_d.z * u_xlat1_d.y) + 1);
          u_xlat0_d.z = (u_xlat0_d.z * 0.31831);
          u_xlat1_d.y = ((u_xlat1_d.y * u_xlat1_d.y) + 0);
          u_xlat0_d.z = (u_xlat0_d.z / u_xlat1_d.y);
          u_xlat0_d.z = (u_xlat0_d.z * u_xlat0_d.w);
          u_xlat0_d.z = (u_xlat0_d.z * 3.141593);
          u_xlat0_d.z = max(u_xlat0_d.z, 0.0001);
          u_xlat0_d.z = sqrt(u_xlat0_d.z);
          u_xlat0_d.yz = (u_xlat1_d.xx * u_xlat0_d.yz);
          ...
          u_xlat1_d.xyz = (u_xlat0_d.yyy * u_xlat4.xyz);
          u_xlat0_d.yzw = (u_xlat4.xyz * u_xlat0_d.zzz);
          u_xlat0_d.x = ((-u_xlat0_d.x) + 1);
          u_xlat1_d.w = (u_xlat0_d.x * u_xlat0_d.x);
          u_xlat1_d.w = (u_xlat1_d.w * u_xlat1_d.w);
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat1_d.w);
          u_xlat4.xyz = ((-u_xlat2_d.xyz) + float3(1, 1, 1));
          u_xlat2_d.xyz = ((u_xlat4.xyz * u_xlat0_d.xxx) + u_xlat2_d.xyz);
          u_xlat0_d.xyz = (u_xlat0_d.yzw * u_xlat2_d.xyz);
          u_xlat0_d.xyz = ((u_xlat3.xyz * u_xlat1_d.xyz) + u_xlat0_d.xyz);
    ...
    Pass // ind: 3, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          if((u_xlat0_d.w!=0))
          {
              ...
              u_xlat2_d.xyz = (in_f.texcoord2.yyy * unity_ProbeVolumeMin.xyz);
              u_xlat2_d.xyz = ((unity_ProbeVolumeMin.xyz * in_f.texcoord2.xxx) + u_xlat2_d.xyz);
              u_xlat2_d.xyz = ((unity_ProbeVolumeMin.xyz * in_f.texcoord2.zzz) + u_xlat2_d.xyz);
              u_xlat2_d.xyz = (u_xlat2_d.xyz + unity_ProbeVolumeMin.xyz);
              u_xlat2_d.xyz = (u_xlat0_d.www)?(u_xlat2_d.xyz):(in_f.texcoord2.xyz);
              u_xlat2_d.xyz = (u_xlat2_d.xyz - unity_ProbeVolumeMin.xyz);
              u_xlat2_d.yzw = (u_xlat2_d.xyz * unity_ProbeVolumeMin.xyz);
              u_xlat0_d.w = (u_xlat2_d.y * 0.25);
              u_xlat1_d.w = (unity_ProbeVolumeMin.z * 0.5);
              u_xlat2_d.y = (((-unity_ProbeVolumeMin.z) * 0.5) + 0.25);
              u_xlat0_d.w = max(u_xlat0_d.w, u_xlat1_d.w);
              u_xlat2_d.x = min(u_xlat2_d.y, u_xlat0_d.w);
              ...
              u_xlat5.w = 1;
              u_xlat3_d.x = dot(u_xlat3_d, u_xlat5);
              u_xlat3_d.y = dot(u_xlat4, u_xlat5);
              u_xlat3_d.z = dot(u_xlat2_d, u_xlat5);
          }
          else
          {
              u_xlat0_d.w = (in_f.SV_InstanceID.x + unity_BaseInstanceID.x);
              u_xlat0_d.w = ((u_xlat0_d.w * 7) & -1);
              u_xlat2_d.xyz = in_f.texcoord1.xyz;
              u_xlat2_d.w = 1;
              u_xlat3_d.x = dot(unity_SHCArray, u_xlat2_d);
              u_xlat3_d.y = dot(unity_SHCArray, u_xlat2_d);
              u_xlat3_d.z = dot(unity_SHCArray, u_xlat2_d);
          }
          ...
          u_xlat2_d.xyz = max(u_xlat2_d.xyz, float3(0, 0, 0));
          u_xlat0_d.xyz = ((u_xlat0_d.xyz * _Color.xyz) + float3(-0.220916, (-0.220916), (-0.220916)));
          out_f.color1.xyz = ((_Color.zzz * u_xlat0_d.xyz) + float3(0.220916, 0.220916, 0.220916));
          u_xlat0_d.x = (((-_Color.z) * 0.779084) + 0.779084);
          u_xlat0_d.xyz = (u_xlat0_d.xxx * u_xlat1_d.xyz);
          out_f.color3.xyz = (u_xlat2_d.xyz * u_xlat0_d.xyz);
          out_f.color.xyz = u_xlat0_d.xyz;
          out_f.color.w = 1;
          out_f.color1.w = _Color.y;
